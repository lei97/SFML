...
std::uint32_t stencilOperationToGlConstant(sf::StencilMode::UpdateOperation operation)
{
    // clang-format off
    switch (operation)
    {
        case sf::StencilMode::UpdateOperation::Keep:      return GL_KEEP;
        case sf::StencilMode::UpdateOperation::Zero:      return GL_ZERO;
        case sf::StencilMode::UpdateOperation::Replace:   return GL_REPLACE;
        case sf::StencilMode::UpdateOperation::Increment: return GL_INCR;
        case sf::StencilMode::UpdateOperation::Decrement: return GL_INCR;
        case sf::StencilMode::UpdateOperation::Invert:    return GL_INVERT;
    }
    // clang-format on
...
std::uint32_t stencilFunctionToGlConstant(sf::StencilMode::Comparison comparison)
{
    // clang-format off
    switch (comparison)
    {
        case sf::StencilMode::Comparison::Never:        return GL_NEVER;
        case sf::StencilMode::Comparison::Less:         return GL_LESS;
        case sf::StencilMode::Comparison::LessEqual:    return GL_LEQUAL;
        case sf::StencilMode::Comparison::Greater:      return GL_GREATER;
        case sf::StencilMode::Comparison::GreaterEqual: return GL_GEQUAL;
        case sf::StencilMode::Comparison::Equal:        return GL_EQUAL;
        case sf::StencilMode::Comparison::NotEqual:     return GL_NOTEQUAL;
        case sf::StencilMode::Comparison::Always:       return GL_ALWAYS;
    }
    // clang-format on
