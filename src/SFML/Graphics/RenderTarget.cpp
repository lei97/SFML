...
IntRect RenderTarget::getViewport(const View& view) const
{
    ...
    return IntRect({static_cast<int>(std::lround(width * viewport.left)),
                    static_cast<int>(std::lround(height * viewport.top))},
                   {static_cast<int>(std::lround(width * viewport.width)),
                    static_cast<int>(std::lround(height * viewport.height))});
}
...
IntRect RenderTarget::getScissor(const View& view) const
{
    ...
    return IntRect({static_cast<int>(std::lround(width * scissor.left)),
                    static_cast<int>(std::lround(height * scissor.top))},
                   {static_cast<int>(std::lround(width * scissor.width)),
                    static_cast<int>(std::lround(height * scissor.height))});
}
